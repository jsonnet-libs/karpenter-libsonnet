---
permalink: /1.13/aws/karpenter/v1/ec2NodeClass/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withCapacityReservationSelectorTerms(capacityReservationSelectorTerms)`](#fn-specwithcapacityreservationselectorterms)
  * [`fn withCapacityReservationSelectorTermsMixin(capacityReservationSelectorTerms)`](#fn-specwithcapacityreservationselectortermsmixin)
  ...
  * [`fn withIpPrefixCount(ipPrefixCount)`](#fn-specwithipprefixcount)
  ...
  * [`obj spec.amiSelectorTerms`](#obj-specamiselectorterms)
    ...
    * [`fn withSsmParameter(ssmParameter)`](#fn-specamiselectortermswithssmparameter)
  ...
  * [`obj spec.blockDeviceMappings`](#obj-specblockdevicemappings)
    ...
    * [`obj spec.blockDeviceMappings.ebs`](#obj-specblockdevicemappingsebs)
      ...
      * [`fn withVolumeInitializationRate(volumeInitializationRate)`](#fn-specblockdevicemappingsebswithvolumeinitializationrate)
  ...
  * [`obj spec.capacityReservationSelectorTerms`](#obj-speccapacityreservationselectorterms)
    * [`fn withId(id)`](#fn-speccapacityreservationselectortermswithid)
    * [`fn withInstanceMatchCriteria(instanceMatchCriteria)`](#fn-speccapacityreservationselectortermswithinstancematchcriteria)
    * [`fn withOwnerID(ownerID)`](#fn-speccapacityreservationselectortermswithownerid)
    * [`fn withTags(tags)`](#fn-speccapacityreservationselectortermswithtags)
    * [`fn withTagsMixin(tags)`](#fn-speccapacityreservationselectortermswithtagsmixin)
  * [`obj spec.connectionTracking`](#obj-specconnectiontracking)
    * [`fn withTcpEstablishedTimeout(tcpEstablishedTimeout)`](#fn-specconnectiontrackingwithtcpestablishedtimeout)
    * [`fn withUdpStreamTimeout(udpStreamTimeout)`](#fn-specconnectiontrackingwithudpstreamtimeout)
    * [`fn withUdpTimeout(udpTimeout)`](#fn-specconnectiontrackingwithudptimeout)
  * [`obj spec.cpuOptions`](#obj-speccpuoptions)
    * [`fn withNestedVirtualization(nestedVirtualization)`](#fn-speccpuoptionswithnestedvirtualization)
  ...
  * [`obj spec.networkInterfaces`](#obj-specnetworkinterfaces)
    * [`fn withDeviceIndex(deviceIndex)`](#fn-specnetworkinterfaceswithdeviceindex)
    * [`fn withInterfaceType(interfaceType)`](#fn-specnetworkinterfaceswithinterfacetype)
    * [`fn withNetworkCardIndex(networkCardIndex)`](#fn-specnetworkinterfaceswithnetworkcardindex)
  * [`obj spec.placementGroupSelector`](#obj-specplacementgroupselector)
    * [`fn withId(id)`](#fn-specplacementgroupselectorwithid)
    * [`fn withName(name)`](#fn-specplacementgroupselectorwithname)
...
### fn spec.withCapacityReservationSelectorTerms

```ts
withCapacityReservationSelectorTerms(capacityReservationSelectorTerms)
```
...
### fn spec.withCapacityReservationSelectorTermsMixin

```ts
withCapacityReservationSelectorTermsMixin(capacityReservationSelectorTerms)
```
...
### fn spec.withIpPrefixCount

```ts
withIpPrefixCount(ipPrefixCount)
```
...
### fn spec.amiSelectorTerms.withSsmParameter

```ts
withSsmParameter(ssmParameter)
```
...
### fn spec.blockDeviceMappings.ebs.withVolumeInitializationRate
...
## obj spec.capacityReservationSelectorTerms

"CapacityReservationSelectorTerms is a list of capacity reservation selector terms. Each term is ORed together to\ndetermine the set of eligible capacity reservations."

### fn spec.capacityReservationSelectorTerms.withId
...
### fn spec.capacityReservationSelectorTerms.withInstanceMatchCriteria
...
### fn spec.capacityReservationSelectorTerms.withOwnerID
...
### fn spec.capacityReservationSelectorTerms.withTags
...
### fn spec.capacityReservationSelectorTerms.withTagsMixin
...
### fn spec.connectionTracking.withTcpEstablishedTimeout
...
### fn spec.connectionTracking.withUdpStreamTimeout
...
### fn spec.connectionTracking.withUdpTimeout
...
### fn spec.cpuOptions.withNestedVirtualization

```ts
withNestedVirtualization(nestedVirtualization)
```
...
## obj spec.networkInterfaces

"NetworkInterfaces specifies the network interface configurations to be attached to provisioned instances."

### fn spec.networkInterfaces.withDeviceIndex
...
### fn spec.networkInterfaces.withInterfaceType
...
### fn spec.networkInterfaces.withNetworkCardIndex
...
### fn spec.placementGroupSelector.withName
