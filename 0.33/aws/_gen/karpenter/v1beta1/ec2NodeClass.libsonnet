{
  ...
  '#spec':: d.obj(help='"EC2NodeClassSpec is the top level specification for the AWS Karpenter Provider. This will contain configuration necessary to launch instances in AWS."'),
  spec: {
    ...
    amiSelectorTerms: {
      ...
      withId(id): { id: id },
      '#withName':: d.fn(help='"Name is the ami name in EC2. This value is the name field, which is different from the name tag."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { name: name },
      '#withOwner':: d.fn(help='"Owner is the owner for the ami. You can specify a combination of AWS account IDs, \\"self\\", \\"amazon\\", and \\"aws-marketplace\\', args=[d.arg(name='owner', type=d.T.string)]),
      withOwner(owner): { owner: owner },
      '#withTags':: d.fn(help="\"Tags is a map of key/value tags used to select subnets Specifying '*' for a value selects all values for a given tag key.\"", args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { tags: tags },
      '#withTagsMixin':: d.fn(help="\"Tags is a map of key/value tags used to select subnets Specifying '*' for a value selects all values for a given tag key.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='tags', type=d.T.object)]),
    ...
    blockDeviceMappings: {
      ...
      ebs: {
        ...
        '#withVolumeSize':: d.fn(help='"VolumeSize in `Gi`, `G`, `Ti`, or `T`. You must specify either a snapshot ID or a volume size. The following are the supported volumes sizes for each volume type: \\n * gp2 and gp3: 1-16,384 \\n * io1 and io2: 4-16,384 \\n * st1 and sc1: 125-16,384 \\n * standard: 1-1,024"', args=[d.arg(name='volumeSize', type=d.T.any)]),
      ...
      '#withRootVolume':: d.fn(help='"RootVolume is a flag indicating if this device is mounted as kubelet root dir. You can configure at most one root volume in BlockDeviceMappings."', args=[d.arg(name='rootVolume', type=d.T.boolean)]),
    ...
    securityGroupSelectorTerms: {
      ...
      withId(id): { id: id },
      '#withName':: d.fn(help='"Name is the security group name in EC2. This value is the name field, which is different from the name tag."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { name: name },
      '#withTags':: d.fn(help="\"Tags is a map of key/value tags used to select subnets Specifying '*' for a value selects all values for a given tag key.\"", args=[d.arg(name='tags', type=d.T.object)]),
      withTags(tags): { tags: tags },
      '#withTagsMixin':: d.fn(help="\"Tags is a map of key/value tags used to select subnets Specifying '*' for a value selects all values for a given tag key.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='tags', type=d.T.object)]),
