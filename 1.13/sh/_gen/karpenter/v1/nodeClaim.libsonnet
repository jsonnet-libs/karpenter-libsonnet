{
  ...
  spec: {
    ...
    nodeClassRef: {
      ...
      withGroup(group): { spec+: { nodeClassRef+: { group: group } } },
    ...
    withExpireAfter(expireAfter): { spec+: { expireAfter: expireAfter } },
    ...
    withTerminationGracePeriod(terminationGracePeriod): { spec+: { terminationGracePeriod: terminationGracePeriod } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
