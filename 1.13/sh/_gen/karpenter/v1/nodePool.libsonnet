  ...
  spec: {
    ...
    disruption: {
      ...
      budgets: {
        ...
        '#withReasons':: d.fn(help='"reasons is a list of disruption methods that this budget applies to. If Reasons is not set, this budget applies to all methods.\\nOtherwise, this will apply to each reason defined.\\nallowed reasons are Underutilized, Empty, and Drifted."', args=[d.arg(name='reasons', type=d.T.array)]),
        withReasons(reasons): { reasons: if std.isArray(v=reasons) then reasons else [reasons] },
        '#withReasonsMixin':: d.fn(help='"reasons is a list of disruption methods that this budget applies to. If Reasons is not set, this budget applies to all methods.\\nOtherwise, this will apply to each reason defined.\\nallowed reasons are Underutilized, Empty, and Drifted."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='reasons', type=d.T.array)]),
    ...
    template: {
      ...
      spec: {
        ...
        requirements: {
          ...
          '#withOperator':: d.fn(help="\"Represents a key's relationship to a set of values.\\nValid operators are In, NotIn, Exists, DoesNotExist. Gt, Lt, Gte, and Lte.\"", args=[d.arg(name='operator', type=d.T.string)]),
        ...
        withExpireAfter(expireAfter): { spec+: { template+: { spec+: { expireAfter: expireAfter } } } },
        ...
        '#withTerminationGracePeriod':: d.fn(help="\"TerminationGracePeriod is the maximum duration the controller will wait before forcefully deleting the pods on a node, measured from when deletion is first initiated.\\n\\nWarning: this feature takes precedence over a Pod's terminationGracePeriodSeconds value, and bypasses any blocked PDBs or the karpenter.sh/do-not-disrupt annotation.\\n\\nThis field is intended to be used by cluster administrators to enforce that nodes can be cycled within a given time period.\\nWhen set, drifted nodes will begin draining even if there are pods blocking eviction. Draining will respect PDBs and the do-not-disrupt annotation until the TGP is reached.\\n\\nKarpenter will preemptively delete pods so their terminationGracePeriodSeconds align with the node's terminationGracePeriod.\\nIf a pod would be terminated without being granted its full terminationGracePeriodSeconds prior to the node timeout,\\nthat pod will be deleted at T = node timeout - pod terminationGracePeriodSeconds.\\n\\nThe feature can also be used to allow maximum time limits for long-running jobs which can delay node termination with preStop hooks.\\nIf left undefined, the controller will wait indefinitely for pods to be drained.\"", args=[d.arg(name='terminationGracePeriod', type=d.T.string)]),
        withTerminationGracePeriod(terminationGracePeriod): { spec+: { template+: { spec+: { terminationGracePeriod: terminationGracePeriod } } } },
      },
    },
    '#withLimits':: d.fn(help='"Limits define a set of bounds for provisioning capacity.\\nLimits other than limits.nodes is not supported when replicas is set."', args=[d.arg(name='limits', type=d.T.object)]),
