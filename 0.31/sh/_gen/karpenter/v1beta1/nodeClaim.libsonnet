{
  ...
  spec: {
    '#kubelet':: d.obj(help='"Kubelet defines args to be used when configuring kubelet on provisioned nodes. They are a subset of the upstream types, recognizing not all options may be supported. Wherever possible, the types and names should reflect the upstream kubelet types."'),
    kubelet: {
    ...
    '#nodeClass':: d.obj(help='"NodeClass is a reference to an object that defines provider specific configuration"'),
    nodeClass: {
      '#withApiVersion':: d.fn(help='"API version of the referent"', args=[d.arg(name='apiVersion', type=d.T.string)]),
      withApiVersion(apiVersion): { spec+: { nodeClass+: { apiVersion: apiVersion } } },
      ...
      withKind(kind): { spec+: { nodeClass+: { kind: kind } } },
      ...
      withName(name): { spec+: { nodeClass+: { name: name } } },
    },
