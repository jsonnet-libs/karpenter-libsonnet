    ...
    template: {
      ...
      spec: {
        ...
        nodeClass: {
          ...
          withApiVersion(apiVersion): { spec+: { template+: { spec+: { nodeClass+: { apiVersion: apiVersion } } } } },
          ...
          withKind(kind): { spec+: { template+: { spec+: { nodeClass+: { kind: kind } } } } },
          ...
          withName(name): { spec+: { template+: { spec+: { nodeClass+: { name: name } } } } },
        },
